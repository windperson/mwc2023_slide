...
Support [CSS Variables](https://developer.mozilla.org/en-US/docs/Web/CSS/Using_CSS_custom_properties){taget="_blank"}, so we can programmatically change CSS style in C# code.
