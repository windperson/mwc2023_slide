...
A Razor component is a self-contained chunk of user interface (UI), such as a page, dialog, or form. A component includes HTML markup and the processing logic required to inject data or respond to UI events.

* Razor syntax for embedding C# code in HTML markup
* Razor components can be nested, reused, shared among projects
* using a `.razor` file extension:
